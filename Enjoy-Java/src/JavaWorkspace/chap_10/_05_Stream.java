...
//        "python", "java", "javascript", "c", "c++", "c#"
        ...
        // 4글자 이하 언어 중에서 c 라는 글자를 포함하는 언어
        langList.stream()
                .filter(x -> x.length() <= 4)
        ...
        // 4 글자 이하 언어 중에서 c 라는 글자를 포함하는 언어가 하나라도 있는지 여부
        ...
        // 4글자 이하 언어들은 모두 c 라는 글자를 포함하는지 여부
        ...
        // 4글자 이하 언어 중에서 c 라는 글자를 포함하는 언어 뒤에 (어려워요) 라는 글자 함께 출력
        langList.stream()
                .filter(x -> x.length() <= 4)
                .filter(x -> x.contains("c"))
                .map(x -> x + " 어려워요")
        ...
        // c 라는 글자를 포함하는 언어를 대문자로 변경해 리스트로 저장
