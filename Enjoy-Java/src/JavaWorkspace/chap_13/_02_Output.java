...
public class _02_Output {
    public static void main(String[] args) {
        ...
        System.out.printf("%6d", 1234); // 6자리 공간을 확보하고 나서 1234 출력 >> __1234
        System.out.printf("%06d%n", 1234); // 6자리 공간 확보 후 1234 출력하는데 빈 공간은 0으로 채움 >> 001234
        System.out.printf("%06d%n", -1234); // _-1234
        System.out.printf("%+6d%n", 1234); // _+1234
        System.out.printf("%, 15d%n", 1000000000); // __1,000,000,000 (세자리마다 콤마로 구분)
        System.out.printf("%-6d%n", 1234); // 6자리 공간 확보하고 나서 왼쪽 정렬 1234 출력
